      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-primary/5 py-16 md:py-0">
        <div className="container mx-auto px-4 flex flex-col-reverse md:grid md:grid-cols-2 gap-12 items-center relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-headline font-extrabold leading-[1.1] mb-6 whitespace-pre-line">
              {siteData?.hero_title ? (
                <span dangerouslySetInnerHTML={{ __html: siteData.hero_title.replace("Wagging Tails!", "<span class='text-primary italic font-accent'>Wagging Tails!</span>") }} />
              ) : (
                <>Where Dreams Meet <span className="text-primary italic font-accent">Wagging Tails!</span></>
              )}
            </h1>
            <p className="text-lg text-muted-foreground mb-10 max-w-lg whitespace-pre-line">
              {siteData?.hero_subtitle || "More than just a breeding camp — we are a haven for dogs and dog lovers.\nDedicated to connecting deserving dogs with loving families through responsible breeding and compassionate adoption."}
            </p>
