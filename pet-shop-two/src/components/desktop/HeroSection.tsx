...
export default function HeroSection({ siteData }: { siteData: SiteContent | null }) {
    ...
    return (
        <section id="hero" className="relative h-screen w-full overflow-hidden">
            ...
            <div className="relative z-20 h-full flex flex-col items-center justify-center text-center px-6">
                ...
                <h1
                    className="font-heading text-5xl md:text-6xl lg:text-7xl font-extrabold text-white mb-6 animate-fade-in-up max-w-4xl leading-tight whitespace-pre-line"
                    style={{ animationDelay: '200ms', animationFillMode: 'both' }}
                >
                    {siteData?.hero_title ? (
                        <span dangerouslySetInnerHTML={{ __html: siteData.hero_title.replace("Your Pet's Favorite Place", "Your Pet's\n<span class='bg-gradient-to-r from-[#5FBDB3] to-[#F4B860] bg-clip-text text-transparent'>Favorite Place</span>") }} />
                    ) : (
                        <>
                            Find Your Perfect
                            <br />
                ...
                <p
                    className="text-lg md:text-xl text-white/85 max-w-2xl mb-10 animate-fade-in-up font-light leading-relaxed whitespace-pre-line"
                    style={{ animationDelay: '400ms', animationFillMode: 'both' }}
                >
                    {siteData?.hero_subtitle || "Discover healthy, happy pets ready to fill your home with love.\nDogs, cats, birds & exotic companions — all from trusted breeders."}
                </p>
